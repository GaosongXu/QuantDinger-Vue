...
'indicatorIde.editor.fastLessThanSlow': 'Fast line parameter must be less than slow line parameter',
  ...
  'trading-bot.grid.riskGuardsTitle': 'Biên và kiểm soát rủi ro',
  'trading-bot.grid.adaptiveBounds': 'Biên thích ứng',
  'trading-bot.grid.adaptiveBoundsHint': 'Dịch chuyển biên trên/dưới theo biến động ATR gần đây; mở rộng khi giá sát mép.',
  'trading-bot.grid.adaptiveAtrMult': 'Hệ số độ rộng ATR',
  'trading-bot.grid.adaptiveAtrMultHint': 'Càng cao = dải càng rộng, lưới thưa hơn. Mặc định 2.0.',
  'trading-bot.grid.waterfallProtection': 'Chống sập (tạm dừng khi giảm mạnh)',
  'trading-bot.grid.waterfallProtectionHint': 'Tạm dừng lệnh mới khi giá giảm nhanh; tự tiếp tục sau thời gian chờ.',
  'trading-bot.grid.waterfallDropPct': '% drawdown kích hoạt',
  'trading-bot.grid.waterfallDropPctHint': 'Tạm dừng khi giá giảm % này so với đỉnh gần nhất (mặc định 3%).',
